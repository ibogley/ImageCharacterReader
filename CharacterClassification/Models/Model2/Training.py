...
learning_rate = 0.001
num_epochs = 20
num_classes = DataObject.num_classes  # Adjust based on your dataset
...
#Prevent this from running if this file is imported
if __name__ == "__main__":
    # Initialize model
    model = Model2(num_classes=num_classes).to(device)
